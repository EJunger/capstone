...
let StudentResolver = class StudentResolver {
    ...
    async studentDetails(parent) {
        return `${parent.school} ${parent.email}`;
    }
    async students(school, email) {
...
], StudentResolver.prototype, "sampple", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], StudentResolver.prototype, "studentDetails", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => String),
    __param(0, (0, type_graphql_1.Arg)('school')),
